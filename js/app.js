...
function counter() {
  ...
  if (bigTime == 0) {
    ...
    if (mode == "normal") {
      completedTimeIntervals += 1;
      console.log('Adding 1 to completedTimeIntervals');
      addCircle(completedTimeIntervals);
      // cooldown is 5min
      mode = "cooldown";
      bigTime = 300;
...
// KEEP TRACK OF COMPLETED TIME INTERVALS ====================
function addCircle(completedTimeIntervals) {
    ...
    var pt1 = new jsPoint(1000,30*completedTimeIntervals + 5 *(completedTimeIntervals - 1));


    //Draw filled circle with pt1 as center point and radius 30.
    gr.fillCircle(col,pt1,15);
}
